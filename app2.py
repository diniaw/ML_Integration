...
data = {
    ...
    'education': st.selectbox('Pendidikan', ['Sarjana','Tidak Sarjana']),'self_employed': st.selectbox('Wiraswasta', ['Ya','Tidak']),
...
if st.button('Prediksi Persetujuan Pinjaman'):
    try:
        ...
        if probability > 0.7:
            ...
            st.warning('Probabilitias rendah, data tidak disimpan.')
